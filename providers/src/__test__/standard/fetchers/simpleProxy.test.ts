...
describe('makeSimpleProxyFetcher()', () => {
  ...
  it('should pass options through', () => {
    ...
    expectFetchCall({
      ...
      outputUrl: `https://example.com/proxy?type=web&url=${encodeURIComponent('https://google.com/')}`,
      output: {
        method: 'GET',
        headers: {
          'X-Hello': 'world',
    ...
    expectFetchCall({
      ...
      outputUrl: `https://example.com/proxy?type=web&url=${encodeURIComponent('https://google.com/?a=b')}`,
      output: {
        method: 'GET',
        headers: {},
        signal: new AbortController().signal,
